...
faq:
  ...
  - q: "How long should a cold outreach email be?"
    a: "Under 150 words. Busy people scan emails. Lead with the value for them, not who you are. Three sentences: what you do, why it's relevant to them, one specific ask."
  - q: "How many follow-ups should you send?"
    a: "2-3 follow-ups maximum. Space them 3-5 days apart. Each follow-up should add new value, not just ask again. Stop after 3 if no response — don't burn bridges."
  - q: "What subject lines work best for cold email?"
    a: "Personalized and specific beat generic every time. '[Their name], saw your post about X' outperforms 'Partnership opportunity' by 3-5x. Keep subject lines under 50 characters."
  - q: "Is cold email legal?"
    a: "Yes, B2B cold email is legal in most countries if you include your business info, an unsubscribe option, and don't misrepresent yourself. CAN-SPAM (US) and GDPR (EU) apply — always include opt-out."
---
...
- `[First name], quick question about [their company]`
...
- [ ] Use a secondary domain (not your main domain) for cold outreach: e.g., `hello@getmyproduct.com` rather than `me@myproduct.com`
- [ ] Warm up the inbox for 2-4 weeks before sending cold email (tools: Instantly, Mailreach, Warmbox)
...
For more SaaS growth tools and templates, visit the [growth tools directory](https://gingiris.github.io/growth-tools/).
