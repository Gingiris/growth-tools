...
faq:
  - q: "How do you get GitHub stars fast?"
    a: "The fastest legitimate paths to GitHub stars: (1) Launch on Hacker News (Show HN) — a front-page HN post can generate 500-2,000 stars in 24 hours. (2) Product Hunt launch — 200-500 stars from a top-10 finish. (3) Community seeding in relevant subreddits and Discord servers. (4) Getting featured in a popular newsletter or influencer tweet. (5) Being mentioned in a widely-shared blog post. The fastest organic tactic: a genuinely useful README that developers bookmark and share."
  - q: "Do GitHub stars affect search ranking?"
    a: "GitHub stars directly influence GitHub's own search algorithm — more stars = higher ranking for relevant searches within GitHub. They also serve as social proof that increases click-through when your repo appears in search results. Stars don't directly influence Google rankings, but the backlinks and mentions generated by star growth (blog posts, tweets, newsletter mentions) do accumulate SEO value over time."
  - q: "What is a good number of GitHub stars?"
    a: "Context matters more than absolute numbers. Rough benchmarks: 100 stars = people find it credible enough to try. 1,000 stars = legitimately popular in a niche. 5,000 stars = well-known in the developer community. 10,000+ = significant open source project. 50,000+ = top tier (Linux, React, Vue level). For a new library or tool, reaching 100 stars in the first month and 1,000 in the first year is strong growth."
---
